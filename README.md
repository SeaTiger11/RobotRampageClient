...
The client is written using c++ and vulkan as a 3D game engine while the backend server will likely be predominantly php as the multiplayer aspects are semi asychronous however this may change during testing to a Node.js approach. The planned structure of the backend roughly follows the MQTT approach.
